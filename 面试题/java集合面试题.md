...
![jdk1.8 之前的内部结构-HashMap](https://img.ggball.top/picGo/jdk1.7_hashmap.png)

#### JDK1.8 之后

相比于之前的版本， JDK1.8 之后在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为 8）（将链表转换成红黑树前会判断，如果当前数组的长度小于 64，那么会选择先进行数组扩容，而不是转换为红黑树）时，将链表转化为红黑树，以减少搜索时间。

![jdk1.8_hashmap](https://img.ggball.top/picGo/jdk1.8_hashmap.png)
...
![Hashtable](https://img.ggball.top/picGo/Hashtable.png)
...
![Java7 ConcurrentHashMap 存储结构](https://img.ggball.top/picGo/java7_concurrenthashmap.png)
...
![Java8 ConcurrentHashMap 存储结构](https://img.ggball.top/picGo/java8_concurrenthashmap.png)
...
![java7_concurrenthashmap1](https://img.ggball.top/picGo/java7_concurrenthashmap1.png)
...
![java8_concurrenthashmap1](https://img.ggball.top/picGo/java8_concurrenthashmap1.png)
...
### 11. 说说 List, Set, Queue, Map 四者的区别？
...
### 17. 说一说 ArrayList 的扩容机制吧

详见笔主的这篇文章: [ArrayList 扩容机制分析open in new window](https://javaguide.cn/java/collection/arraylist-source-code.html#_3-1-%E5%85%88%E4%BB%8E-arraylist-%E7%9A%84%E6%9E%84%E9%80%A0%E5%87%BD%E6%95%B0%E8%AF%B4%E8%B5%B7)
...
### 21. ArrayDeque 与 LinkedList 的区别
