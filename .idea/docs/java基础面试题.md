...
![Java程序转变为机器代码的过程](https://img.ggball.top/picGo/Java程序转变为机器代码的过程.png)
...
![编译型语言和解释型语言](https://img.ggball.top/picGo/编译型语言和解释型语言1.png)
...
### 39. 为什么重写 equals() 时必须重写 hashCode() 方法？
...
### 40. String、StringBuffer、StringBuilder 的区别？
...
### 43. String#equals() 和 Object#equals() 有何区别？
...
![types-of-exceptions-in-java](https://img.ggball.top/picGo/types-of-exceptions-in-java.png)
...
### 47. Checked Exception 和 Unchecked Exception 有什么区别？
...
### 51. 如何使用 `try-with-resources` 代替`try-catch-finally`？
...
![TCP/IP 四层模型](https://img.ggball.top/picGo/tcp-ip-4-model.png)
